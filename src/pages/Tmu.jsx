    ...
    return (
        <>
            ...
            <div className="tmu-main">
                <h4 className="center-text">We will be leading an exploratory course at Toronto Metropolitan University meant to increase artists' accesibility to non-generative AI tools for art making.</h4>
                <div className="moon">
