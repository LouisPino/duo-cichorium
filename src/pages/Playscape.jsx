...
export default function Playscape() {
    ...
    return (
        <div className="playscape-page">
            ...
            <h5 className="playscape-p">We will be curators at <span className="glow">Array Music</ span> from 2024 to 2027. Join us for <span className="glow">DUO CICHORIUM'S PLAYSCAPE EMPORIUM</ span>, six concerts featuring a wide array of artists from varying disciplines.</h5>
